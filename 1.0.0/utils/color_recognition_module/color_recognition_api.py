...
def color_recognition(crop_img):
  ...
  crop_img = crop_image.crop_center(crop_img, 50, 50) # crop the detected person image and get a image piece from center of it both for debugging and sending that image piece to color recognition module
  # for debugging
  ...
  color_histogram_feature_extraction.color_histogram_of_test_image(crop_img) # send image piece to regonize color
